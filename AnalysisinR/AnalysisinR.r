air_stores <- read_csv("../air_store_info.csv")
air_visits <- read_csv("../air_visit_data.csv")
air_reserve <- read_csv("../air_reserve.csv")
hpg_reserve <- read_csv("../hpg_reserve.csv")
hpg_stores <- read_csv("../hpg_store_info.csv")
store_mapping <- read_csv("../store_id_relation.csv")
holidays <- read_csv("../date_info.csv")
air_prophet <- read_csv("../air_visit_data1Res.csv")
head(air_reserve) 
head(hpg_reserve)
head(air_stores)
head(hpg_stores)
